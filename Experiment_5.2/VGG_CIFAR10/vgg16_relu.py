...
class cifar10vgg:
    ...
    def train(self,model):
        ...
        historytemp = model.fit_generator(datagen.flow(x_train, y_train,
                            ...
                            epochs=maxepoches,validation_data=(x_test, y_test),callbacks=[reduce_lr,save_weights.save_weights(fname='rawdata/vgg16_relu/'+str(self.lr)+'_'+str(self.dropout_rate)+'_'+str(self.width)+'_'+str(self.batch_size)+'_'+str(self.weight_decay)+'_'+str(self.act))],verbose=2)
        return model
